...
public class JQuery implements IMyAction{

	private JQuery(){
		System.err.println("Singleton Accueil Velocity");
	}
	
	public static JQuery getInstance(){
		return JQueryHolder.INSTANCE;
	}
	
	private static class JQueryHolder{
