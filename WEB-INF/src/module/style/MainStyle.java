...
public class MainStyle implements IMyAction{

	private MainStyle(){
		System.err.println("Singleton Accueil Velocity");
	}
	
	public static MainStyle getInstance(){
		return mainStyleHolder.INSTANCE;
	}
	
	private static class mainStyleHolder{
		private static final MainStyle INSTANCE = new MainStyle();
	}
